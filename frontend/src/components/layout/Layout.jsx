  ...
  return (
    ...
    >
      {({ isActive }) => <>
        ...
        {badge && alertCount > 0 && (
          <span style={{ background:'#C2410C', color:'#fff', fontSize:10, fontWeight:700, padding:'1px 6px', borderRadius:99, lineHeight:1.4 }}>
...
function HealthBar({ stats }) {
  ...
  const color   = vencidos > 0 ? '#9A3412' : proximos > 0 ? '#C2410C' : '#34D399';
        ...
        <header style={{
          ...
          <div style={{ display:'flex', alignItems:'center', gap:6, marginLeft:'auto' }}>
            ...
            >
              ...
              {noLeidas > 0 && (
                <span style={{ position:'absolute', top:5, right:5, width:6, height:6, borderRadius:'50%', background:'#C2410C', border:'1.5px solid #7C2D12' }}/>
              )}
            </button>

...
function CumplimientoBar({ valor }) {
  const color = valor >= 80 ? '#059669' : valor >= 50 ? '#C2410C' : '#9A3412';
  return (
    ...
    <div className="page">
      ...
      <div className="grid-4" style={{ flexShrink:0 }}>
        {[
          ...
          { label:'BORRADORES',       val:borradores, ic:'#78716C', bg:'#F5F5F4', Icon:Clock },
          { label:'APROBADOS',        val:aprobados,  ic:'#059669', bg:'#D1FAE5', Icon:CheckCircle },
          { label:'REQUIEREN ACCIÓN', val:requieren,  ic:'#9A3412', bg:'#FED7AA', Icon:AlertTriangle },
        ...
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setModal(false)}>
          <div className="modal" style={{ maxWidth:640 }}>
            ...
            <div style={{ padding:'0 24px 24px', display:'flex', flexDirection:'column', gap:14 }}>
              <div style={{ background:'#F5F5F4', border:'1px solid #D6D3D1', borderRadius:8, padding:'10px 14px', fontSize:11, color:'#78716C', lineHeight:1.6 }}>
